...
for (int i = 0; i < result; i++)
{
    if (result % num20 == 0)
    {
        ...
        Console.WriteLine($"So I should return you $20 bill.");
        break;
    }
    ...
    if (result % num10 == 0)
    {
        ...
        Console.WriteLine($"So I should return you $10 bill.");
        break;
    }
    ...
    if (result % num5 == 0)
    {
        ...
        Console.WriteLine($"So I should return you $5 bill.");
        break;
    }
    ...
    if (result % num2 == 0)
    {
        ...
        Console.WriteLine($"So I should return you Coins of $2");
        break;
    }
    ...
    if (result % num1 == 0)
    {
        ...
        Console.WriteLine($"So I should return you Coins of $1");
        break;
    }
